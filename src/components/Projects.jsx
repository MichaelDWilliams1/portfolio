  ...
  return (
    <section id='projectSection' className='h-auto lg:h-screen bg-blue-500 justify-center pb-16'>
        ...
        <div className='md:w-700 lg:w-1000 xl:w-1200 lg:h-full flex flex-col lg:flex-row justify-center items-center space-y-10 lg:space-y-0 lg:space-x-10'>
            <div className='2xsm:w-72 xsm:w-96
             md:w-auto lg:h-auto flex flex-col items-center justify-center bg-white-100 shadow-md rounded-md'>
                <div className='w-full md:h-1/2'><img className='rounded-t-md ' src={audiophile} /></div>
                <div className='w-full h-48 md:h-60 lg:h-1/2 flex flex-col justify-evenly lg:justify-around items-center lg:mb-3 lg:space-y-3'>
            ...
            <div className='2xsm:w-72 xsm:w-96 md:w-auto lg:h-auto flex flex-col items-center justify-center bg-white-100 shadow-md rounded-md'>
            <div className='w-full md:h-1/2'><img className='rounded-t-md' src={country} /></div>
                <div className='w-full h-48 md:h-60 lg:h-1/2 flex flex-col justify-evenly lg:justify-around items-center lg:mb-3 lg:space-y-3'>
